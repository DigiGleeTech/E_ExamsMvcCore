...
namespace E_ExamsMvcCore.Controllers
{
    public class CoursesController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            var lecturerUsers = userManager.GetUsersInRoleAsync("Lecturer").Result;

            var lecturerList = lecturerUsers.Select(u => new SelectListItem
            {
                Text = u.UserName,
                Value = u.Id
            }).ToList();
        ...
        public async Task<IActionResult> Create([Bind("Id,CourseName,DepartmentId,LecturerId")] Course course)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CourseName,DepartmentId,LecturerId")] Course course)
        {
            if (id != course.Id)
            {
                return NotFound();
